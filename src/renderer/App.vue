...
import BrowserTabs from './components/BrowserTabs/BrowserTabs.vue'
...
import { installTabNavigationGuard } from './router/index'
...
onMounted(async () => {
  ...
  // Initialize the tab system with the landing page as the first tab
  store.dispatch('initTabs', landingPage.value)
